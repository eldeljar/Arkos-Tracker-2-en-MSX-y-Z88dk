...
; Pattern 0
	...
	db 7	; New speed (>0).
	db 63	; New height.
	db ((Justaddcream_Subsong0_Track17 - ($ + 2)) & #ff00) / 256	; New track (17) for channel 1, as an offset. Offset MSB, then LSB.
	db ((Justaddcream_Subsong0_Track17 - ($ + 1)) & 255)
	db ((Justaddcream_Subsong0_Track22 - ($ + 2)) & #ff00) / 256	; New track (22) for channel 2, as an offset. Offset MSB, then LSB.
	db ((Justaddcream_Subsong0_Track22 - ($ + 1)) & 255)
	db 132	; New track (0) for channel 3, as a reference (index 4).

; Pattern 1
	db 40	; State byte.
	db ((Justaddcream_Subsong0_Track18 - ($ + 2)) & #ff00) / 256	; New track (18) for channel 1, as an offset. Offset MSB, then LSB.
	db ((Justaddcream_Subsong0_Track18 - ($ + 1)) & 255)
	db ((Justaddcream_Subsong0_Track21 - ($ + 2)) & #ff00) / 256	; New track (21) for channel 2, as an offset. Offset MSB, then LSB.
	db ((Justaddcream_Subsong0_Track21 - ($ + 1)) & 255)

; Pattern 2
	db 168	; State byte.
	db 136	; New track (2) for channel 1, as a reference (index 8).
	db ((Justaddcream_Subsong0_Track19 - ($ + 2)) & #ff00) / 256	; New track (19) for channel 2, as an offset. Offset MSB, then LSB.
	db ((Justaddcream_Subsong0_Track19 - ($ + 1)) & 255)
	db ((Justaddcream_Subsong0_Track20 - ($ + 2)) & #ff00) / 256	; New track (20) for channel 3, as an offset. Offset MSB, then LSB.
	db ((Justaddcream_Subsong0_Track20 - ($ + 1)) & 255)

; Pattern 3
	db 160	; State byte.
	db 132	; New track (0) for channel 2, as a reference (index 4).
	db ((Justaddcream_Subsong0_Track29 - ($ + 2)) & #ff00) / 256	; New track (29) for channel 3, as an offset. Offset MSB, then LSB.
...
Justaddcream_Subsong0_Loop
	...
	db ((Justaddcream_Subsong0_Track1 - ($ + 2)) & #ff00) / 256	; New track (1) for channel 3, as an offset. Offset MSB, then LSB.
	db ((Justaddcream_Subsong0_Track1 - ($ + 1)) & 255)

; Pattern 5
	db 168	; State byte.
	db ((Justaddcream_Subsong0_Track24 - ($ + 2)) & #ff00) / 256	; New track (24) for channel 1, as an offset. Offset MSB, then LSB.
	db ((Justaddcream_Subsong0_Track24 - ($ + 1)) & 255)
	db ((Justaddcream_Subsong0_Track25 - ($ + 2)) & #ff00) / 256	; New track (25) for channel 2, as an offset. Offset MSB, then LSB.
	db ((Justaddcream_Subsong0_Track25 - ($ + 1)) & 255)
	db ((Justaddcream_Subsong0_Track26 - ($ + 2)) & #ff00) / 256	; New track (26) for channel 3, as an offset. Offset MSB, then LSB.
...
; Pattern 8
	db 170	; State byte.
	db 31	; New height.
	db ((Justaddcream_Subsong0_Track9 - ($ + 2)) & #ff00) / 256	; New track (9) for channel 1, as an offset. Offset MSB, then LSB.
...
; Pattern 9
	db 40	; State byte.
	db ((Justaddcream_Subsong0_Track10 - ($ + 2)) & #ff00) / 256	; New track (10) for channel 1, as an offset. Offset MSB, then LSB.
	db ((Justaddcream_Subsong0_Track10 - ($ + 1)) & 255)
	db 134	; New track (8) for channel 2, as a reference (index 6).

; Pattern 10
	db 40	; State byte.
	db ((Justaddcream_Subsong0_Track11 - ($ + 2)) & #ff00) / 256	; New track (11) for channel 1, as an offset. Offset MSB, then LSB.
	db ((Justaddcream_Subsong0_Track11 - ($ + 1)) & 255)
	db 133	; New track (7) for channel 2, as a reference (index 5).

; Pattern 11
	db 168	; State byte.
	db ((Justaddcream_Subsong0_Track12 - ($ + 2)) & #ff00) / 256	; New track (12) for channel 1, as an offset. Offset MSB, then LSB.
...
; Pattern 13
	db 128	; State byte.
	db ((Justaddcream_Subsong0_Track6 - ($ + 2)) & #ff00) / 256	; New track (6) for channel 3, as an offset. Offset MSB, then LSB.
...
; Pattern 20
	db 40	; State byte.
	db ((Justaddcream_Subsong0_Track13 - ($ + 2)) & #ff00) / 256	; New track (13) for channel 1, as an offset. Offset MSB, then LSB.
	db ((Justaddcream_Subsong0_Track13 - ($ + 1)) & 255)
	db 135	; New track (28) for channel 2, as a reference (index 7).

; Pattern 21
	db 8	; State byte.
	db ((Justaddcream_Subsong0_Track14 - ($ + 2)) & #ff00) / 256	; New track (14) for channel 1, as an offset. Offset MSB, then LSB.
	db ((Justaddcream_Subsong0_Track14 - ($ + 1)) & 255)

; Pattern 22
	db 8	; State byte.
	db ((Justaddcream_Subsong0_Track15 - ($ + 2)) & #ff00) / 256	; New track (15) for channel 1, as an offset. Offset MSB, then LSB.
	db ((Justaddcream_Subsong0_Track15 - ($ + 1)) & 255)

; Pattern 23
	db 8	; State byte.
	db ((Justaddcream_Subsong0_Track16 - ($ + 2)) & #ff00) / 256	; New track (16) for channel 1, as an offset. Offset MSB, then LSB.
